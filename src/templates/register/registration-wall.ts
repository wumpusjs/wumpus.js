...
const RegistrationWall = new EmbedTemplate({
	...
	description: {
		'en-US':
			"Before you can register and access the full features of our community, please take a moment to read through the server rules. We want to ensure a safe and enjoyable environment for everyone!\n\n✅ Once you've read the rules, click the button below to proceed with registration.\n\nThank you for your cooperation!",
