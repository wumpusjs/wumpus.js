...
type CommandOption = GlobalCommandOptions & (
	{ type: "STRING", minLength?: number, maxLength?: number, /* add autocomplete */ } |
	{ type: "BOOLEAN" } |
	{ type: "CHANNEL", channel_types?: any[] } |
	{ type: "INTEGER", min_value?: number, max_value?: number, /* add autocomplete */ } |
	{ type: "NUMBER", min_value?: number, max_value?: number, /* add autocomplete */ } |
	{ type: "ROLE", /* type: 8 */ } |
	{ type: "USER" } |
...
export type SpecificCommandOption<T extends OptionTypes> = (Omit<Extract<
	CommandOption,
	{ type: T }
...
export type OptionBuilder<T extends OptionTypes> = (
	T extends "STRING" ? SlashCommandStringOption :
	T extends "BOOLEAN" ? SlashCommandBooleanOption :
	T extends "CHANNEL" ? SlashCommandChannelOption :
	T extends "INTEGER" ? SlashCommandIntegerOption :
	T extends "NUMBER" ? SlashCommandNumberOption :
	T extends "ROLE" ? SlashCommandRoleOption :
	T extends "USER" ? SlashCommandUserOption :
	T extends "ATTACHMENT" ? SlashCommandAttachmentOption :
	T extends "MENTIONABLE" ? SlashCommandMentionableOption :
	never
)
